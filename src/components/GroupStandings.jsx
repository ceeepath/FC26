    ...
    <div className="fade-up">
      ...
      {isAdmin && (
        <div className="card" style={{ padding: 20, marginBottom: 24 }}>
          ...
          <div style={{ padding: '14px 16px', background: '#0d0d1a', border: '1px solid #2a2a5a', borderRadius: 10 }}>
            ...
            <div key={group.id} style={{ background: color.bg, border: `1px solid ${color.border}`, borderRadius: 12, overflow: 'hidden' }}>
              <div style={{ padding: '12px 18px', borderBottom: `1px solid ${color.border}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  ...
                  {!isAdmin && <span style={{ fontSize: 12, color: '#4caf50' }}>Top {qualifiers} advance</span>}
                </div>
              </div>
                      ...
                      return (
                        <tr key={row.id} style={{
                          ...
                          <td style={tdStyle('left')}>
                            <span style={{ fontFamily: 'Bebas Neue', fontSize: 15, color: isFirst ? 'var(--gold)' : isDirect ? '#4caf50' : 'var(--text-muted)' }}>
                              {idx + 1}
                            </span>
                          </td>
                          ...
                          <td style={{ ...tdStyle(), color: row.GD > 0 ? '#4caf50' : row.GD < 0 ? 'var(--danger)' : 'var(--text-muted)', fontWeight: row.GD !== 0 ? 700 : 400 }}>
